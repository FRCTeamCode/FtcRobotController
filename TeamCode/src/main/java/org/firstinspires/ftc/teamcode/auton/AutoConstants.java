...
public class AutoConstants {
    ...
    public static final Pose2d RM1_BACKSTAGE = new Pose2d(30.0, -40.0+3.15, Math.toRadians(92.0));
    public static final Pose2d RM1_Tag = new Pose2d(30.0, -28.0, Math.toRadians(92.0));
    ...
    public static final Pose2d BL2_STOP = new Pose2d(14.0, 87.0, Math.toRadians(-92.0));
    public static final Pose2d BL2_STOP_BACK = new Pose2d(14.0, 85.0, Math.toRadians(-92.0));
    //Red far BACKSTAGE side - Right
    public static final Pose2d RR2_way = new Pose2d(24.0, 0.0, Math.toRadians(92.0));
    public static final Pose2d RR2_way_m = new Pose2d(24.0, -26.0, Math.toRadians(92.0));
    public static final Pose2d RR2_PUT = new Pose2d(31.5, -26.0, Math.toRadians(92.0));
    public static final Pose2d RR2_PUTBack = new Pose2d(31.5, -35.0, Math.toRadians(92.0));
    public static final Pose2d RR2_way0 = new Pose2d(25.0, -48.0, Math.toRadians(92.0));
    public static final Pose2d RR2_way1 = new Pose2d(20.0, -60.0, Math.toRadians(92.0));
    public static final Pose2d RR2_way2 = new Pose2d(24.0, -80.0, Math.toRadians(92.0));
    public static final Pose2d RR2_BACKSTAGE = new Pose2d(24.0, -98.0, Math.toRadians(92.0));
    public static final Pose2d RR2_Tag = new Pose2d(24.0, -80.0, Math.toRadians(92.0));
    public static final Pose2d RR2_BACKSTAGE_back = new Pose2d(25.0, -87.0, Math.toRadians(92.0));
    public static final Pose2d RR2_STOP = new Pose2d(14.0, -87.0, Math.toRadians(92.0));
    public static final Pose2d RR2_STOP_BACK = new Pose2d(14.0, -85.0, Math.toRadians(92.0));
    ...
    public static final Pose2d BM2_STOP = new Pose2d(14.0, 87.0, Math.toRadians(-92.0));
    public static final Pose2d BM2_STOP_BACK = new Pose2d(14.0, 85.0, Math.toRadians(-92.0));

    //Red far BACKSTAGE side - Middle
    public static final Pose2d RM2_PUT = new Pose2d(29.6, -4.0, Math.toRadians(0.0));
    public static final Pose2d RM2_way = new Pose2d(26.5, -24.0, Math.toRadians(92.0));
    public static final Pose2d RM2_BACKSTAGE_way = new Pose2d(30.5, -80.0, Math.toRadians(92.0));
    public static final Pose2d RM2_BACKSTAGE = new Pose2d(30.5, -96.8, Math.toRadians(92.0));
    public static final Pose2d RM2_Tag = new Pose2d(30.5, -80.0, Math.toRadians(92.0));
    public static final Pose2d RM2_BACKSTAGE_back = new Pose2d(30.5, -87.0, Math.toRadians(92.0));
    public static final Pose2d RM2_STOP = new Pose2d(14.0, -87.0, Math.toRadians(92.0));
    public static final Pose2d RM2_STOP_BACK = new Pose2d(14.0, -85.0, Math.toRadians(92.0));

    //Blue far BACKSTAGE side - Right - after put pixel, run straight to BACKSTAGE
    public static final Pose2d BR2_PUT = new Pose2d(32.0, 2.0, Math.toRadians(-92.0));
    public static final Pose2d BR2_PUTBack = new Pose2d(32.0, 5.0, Math.toRadians(-92.0));
    ...
    public static final Pose2d BR2_STOP = new Pose2d(14.0, 87.0, Math.toRadians(-92.0));
    public static final Pose2d BR2_STOP_BACK = new Pose2d(14.0, 85.0, Math.toRadians(-92.0));

    //Red far BACKSTAGE side - Left - after put pixel, run straight to BACKSTAGE
    public static final Pose2d RL2_PUT = new Pose2d(32.0, -4.0, Math.toRadians(92.0));
    public static final Pose2d RL2_PUTBack = new Pose2d(32.0, -6.0, Math.toRadians(92.0));
    public static final Pose2d RL2_way0 = new Pose2d(6.0, -6.0, Math.toRadians(92.0));
    public static final Pose2d RL2_way1 = new Pose2d(6.0, -77.0, Math.toRadians(92.0));
    public static final Pose2d RL2_way2 = new Pose2d(36.0, -77.0, Math.toRadians(92.0));
    public static final Pose2d RL2_BACKSTAGE = new Pose2d(37.0, -98.0, Math.toRadians(92.0));
    public static final Pose2d RL2_BACKSTAGE_back = new Pose2d(36.0, -88.0, Math.toRadians(92.0));
    public static final Pose2d RL2_Tag = new Pose2d(36.0, -80.0, Math.toRadians(92.0));
    public static final Pose2d RL2_STOP = new Pose2d(14.0, -88.0, Math.toRadians(92.0));
    public static final Pose2d RL2_STOP_BACK = new Pose2d(14.0, -85.0, Math.toRadians(92.0));//102 go to corner
